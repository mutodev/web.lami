...
export const appRoutes: Route[] = [
    ...
    // Redirect empty path to '/example' 'sales/purchase/new'
        ...
        children   : [
            ...
            },
            {
                ...
                children: [
                    ...
                    { path: 'quotation', loadChildren: () => import('app/modules/sales/quotation/quotation.module').then(m => m.QuotationModule) },
